...
public class ModBiomes extends BiomeGenBase {
    ...
    public static BiomeGenBase sanctuary;
    public static BiomeGenBase purgatory;
    public static BiomeGenBase battlegrounds;
    public static BiomeGenBase ruins;
    public static BiomeGenBase angelCamps;
    public static BiomeGenBase demonCamps;
    public static BiomeGenBase forgottenlands;
    ...
    {
        BiomeDictionary.registerBiomeType(battlegrounds, Type.FOREST);
        BiomeDictionary.registerBiomeType(ruins, Type.SAVANNA);
    ...
    public void genBiomeModdedTerrain(World world, Random random, Block[] replacableBlock, byte[] aByte, int x, int y, double z)
    {
        ...
        for (int l1 = 255; l1 >= 0; --l1)
        {
            ...
            else
            {
                ...
                {
                    if (block2 == RoABlocks.DestinyStone)
                    {
                        if (k == -1)
                        {
                            if (l <= 0)

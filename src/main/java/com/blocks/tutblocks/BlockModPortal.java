...
public class BlockModPortal extends BlockBreakable
{
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != DimensionIDs.KYRODIMENSION) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionIDs.KYRODIMENSION, new DimensionalBreach(thePlayer.mcServer.worldServerForDimension(DimensionIDs.KYRODIMENSION)));
			} else {
				thePlayer.timeUntilPortal = 10;

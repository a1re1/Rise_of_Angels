...
import lib.utility.DimensionalBreach;

import java.util.Random;

import com.kyrodim.world.DimensionIDs;
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			if (thePlayer.timeUntilPortal > 0) {
				...
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionIDs.LIGHTFORESTDIMENSION, new DimensionalBreach(thePlayer.mcServer.worldServerForDimension(DimensionIDs.LIGHTFORESTDIMENSION)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new DimensionalBreach(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}

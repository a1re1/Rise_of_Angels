...
public class BiomeDecoratorMod extends BiomeDecorator
{
	...
	public BiomeDecoratorMod() {
		coalGen = new WorldGenMinable(Blocks.coal_ore, 16, RoABlocks.DestinyStone);
		ironGen = new WorldGenMinable(Blocks.iron_ore, 8, RoABlocks.DestinyStone);
		goldGen = new WorldGenMinable(Blocks.gold_ore, 8, RoABlocks.DestinyStone);
		redstoneGen = new WorldGenMinable(Blocks.redstone_ore, 7, RoABlocks.DestinyStone);
		diamondGen = new WorldGenMinable(Blocks.diamond_ore, 7, RoABlocks.DestinyStone);
		lapisGen = new WorldGenMinable(Blocks.lapis_ore, 6, RoABlocks.DestinyStone);

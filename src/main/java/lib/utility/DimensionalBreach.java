...
public class DimensionalBreach extends Teleporter
{
    ...
    public DimensionalBreach(WorldServer p_i1963_1_)
    {
    	super(p_i1963_1_);
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
            DimensionalBreach.PortalPosition portalposition = (DimensionalBreach.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == Blockss.lightPortal)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == Blockss.lightPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new DimensionalBreach.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == Blockss.lightPortal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == Blockss.lightPortal)
            {
                i4 = 3;
            }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? Blocks.stone : Blockss.lightPortal), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                DimensionalBreach.PortalPosition portalposition = (DimensionalBreach.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());

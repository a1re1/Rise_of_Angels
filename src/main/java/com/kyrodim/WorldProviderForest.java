...
public class WorldProviderForest extends WorldProvider{
	...
	public void registerWorldChunkManager() {
		...
		this.dimensionId = DimensionIDs.KYRODIMENSION;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(DimensionIDs.KYRODIMENSION);
	}
	...
	public String getDimensionName() {
		return "Kyroan Battlegrounds";
	}

	@Override
	/** sets/creates the save folder */
	public String getSaveFolder() {
			return "DIM" + DimensionIDs.KYRODIMENSION;
	}
